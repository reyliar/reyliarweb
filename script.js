const COPY = {
  en: {
    ...
    navContact: "Contact",
    heroEyebrow: "reyliar",
    heroTitle: "Welcome to my page. I build clean websites and edit videos for social media.",
  ...
  tr: {
    ...
    navContact: "İletişim",
    heroEyebrow: "reyliar",
    heroTitle: "Sayfama hoş geldiniz. Hem sade web siteleri kuruyorum hem de sosyal medya videoları kurguluyorum.",
    ...
    statSpeedValue: "Yalın",
    statSpeed: "Performans Odaklı",
